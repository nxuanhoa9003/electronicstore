...
if (isset($_POST['btnAddNew']) && $_POST['btnAddNew'] == 'true') {
    ...
    $sql_InsertDataTblInfoCtgr = mysqli_query($conn, "UPDATE `tableattributescategory` SET `attributeName`=  '$dataAttrbts' WHERE `categoryID` = '$idCategoryAddInfo'");
}
    ...
    <div class="container text-center mt-5">
        ...
        <div class="row g-0">
            <div class="col-12 col-md-12 col-lg-4 content_firstLeft">
                <div class="p-1 mb-2">
                    <h4>Thêm thông tin danh mục</h4>
                </div>

                <!-- option tag -->
                <div class="form-group">
                    <select id="selecCategory" class="col custom-select form-select-lg" aria-label="form-select-lg example">
                                        ...
                                        <form class="formChangeEachElement">
                                            <div class="row d-grid m-0">
                                                <div class="col-12">
                                                    ...
                                                    <input type="hidden" name="tableName" class="tableNameforElement" value="<?php echo $row_Categories['TableName'] ?>">
