...
$strselect = "SELECT * FROM tablecatrgory, tableproducts WHERE tableproducts.category_ID = {$idUrl} AND tableproducts.category_ID = tablecatrgory.categoryID order by tableproducts.category_ID DESC";
$sql_ListCate = mysqli_query($conn, $strselect);
$sql_ListCate2 = mysqli_query($conn, $strselect);
$row_title = mysqli_fetch_array($sql_ListCate);
$title = $row_title !== null ? $row_title['categoryName'] : '';
?>
                ...
                <div class="agileinfo-ads-display col-lg-9">
                    <div class="wrapper">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">
                                <?php
                                while ($row_product = mysqli_fetch_array($sql_ListCate2)) {
                                ?>
