...
if (isset($_POST['logout'])) {
    if ($_POST['logout'] == "true") {
        ...
        setcookie("islogout", "true", time() + 3600, "/");
    }
}
?>
<!-- top-header -->
        ...
        <div class="row main-top-w3l py-2">
            ...
            <div class="col-lg-8 header-right mt-lg-0 mt-2">
                ...
                <ul>
                    ...
                    ?>
                        <li class="text-center border-right text-white">
                            <a href="?manager=viewOrder" class="text-white">
                    ...
                    ?>
                    <li class="text-center border-right text-white">
                        <i class="fas fa-phone mr-2"></i>0999559999
                    </li>
                    ...
                    <?php
                        ...
                        $decodeUser =  base64_decode($_COOKIE['usr']);
                    ?>
                        <li class="user text-center text-white position-relative">
                            <a href="#" class="text-white">
                                <i class="fas fa-user mr-2"></i> <?php echo $decodeUser; ?>
                            </a>

                            <ul class="popover_detail">
                                <li class="item">
...
<?php
include __DIR__ . '/../include/LoginForm.php';
?>
...
<div id="toast" class="toast__container">
    ...
    <!-- <div class="toast toast--success">
        ...
        <div class="toast__content">
            ...
            <p class="toast__message">Đăng ký tài khoản thành công.</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-10 agileits_search">
                        <form id="form_search" class="form-inline">
                            <input class="form-control mr-sm-2" name="keySearch" type="search" placeholder="Tìm kiếm..." aria-label="Search" required />
                    ...
                    <div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
                        <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                            <form action="?manager=shoppingCart" method="post" class="last">
